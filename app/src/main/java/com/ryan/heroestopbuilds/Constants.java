...
/**
 * Constants for easy updating/maintaining
 *
 * @author ryan
 */
public class Constants {
    ...
    public static final String HERO_NAMES[] = {"Abathur", "Anub'arak", "Artanis", "Arthas", "Azmodan",
            "Brightwing", "Chen", "Cho", "Diablo", "E.T.C.", "Falstad", "Gall", "Gazlowe", "Greymane", "Illidan", "Jaina",
            "Johanna", "Kael'thas", "Kerrigan", "Kharazim", "Leoric", "Li Li", "Lt. Morales", "Lunara",
    ...
    public static final int PORTRAITS[] = {R.drawable.abathur, R.drawable.anubarak, R.drawable.artanis,
            ...
            R.drawable.gazlowe, R.drawable.greymane, R.drawable.illidan, R.drawable.jaina,
            R.drawable.johanna, R.drawable.kaelthas, R.drawable.kerrigan, R.drawable.kharazim,
            R.drawable.leoric, R.drawable.li_li, R.drawable.morales, R.drawable.lunara, R.drawable.malfurion,
            R.drawable.muradin, R.drawable.murky, R.drawable.nazeebo, R.drawable.nova,
            R.drawable.raynor, R.drawable.rehgar, R.drawable.rexxar, R.drawable.sergeant_hammer,
