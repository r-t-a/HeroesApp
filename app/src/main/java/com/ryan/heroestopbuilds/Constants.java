...
public class Constants {
    ...
    public static final int PORTRAITS[] = {R.drawable.abathur, R.drawable.anubarak,
            ...
            R.drawable.leoric, R.drawable.li_li, R.drawable.malfurion, R.drawable.muradin,
            R.drawable.murky, R.drawable.nazeebo, R.drawable.nova, R.drawable.raynor,
            R.drawable.rehgar, R.drawable.rexxar, R.drawable.sergeant_hammer,
